...
<body class="main_body">
	<div class="layui-layout layui-layout-admin">
			...
			<div class="layui-main">
			    ...
			    <ul class="layui-nav top_menu">
			    	...
			    	<li class="layui-nav-item" mobile>
			    		<a href="javascript:;" data-url="changePwd"><i class="iconfont icon-shezhi1" data-icon="icon-shezhi1"></i><cite>设置</cite></a>
			    	</li>
			    	<li class="layui-nav-item" mobile>
					...
					<li class="layui-nav-item" pc>
						<a href="javascript:;">
							<img src="/adm/images/userface2.jpg" class="layui-circle" width="35" height="35">
							<cite>{{$realName}}</cite>
						</a>
						<dl class="layui-nav-child">
							...
							<dd><a href="/admin/user/doLogout"><i class="iconfont icon-loginout"></i><cite>退出</cite></a></dd>
						</dl>
					</li>
				</ul>
			</div>
		...
		<div class="layui-side layui-bg-black">
			<div class="user-photo">
				<a class="img" title="我的头像" ><img src="/adm/images/userface2.jpg"></a>
				<p>你好！{{$realName}}<span class="userName"></span>, 欢迎登录</p>
			</div>
		...
		<div class="layui-footer footer">
			<p>copyright @2018 MyBlog后台管理系统 ：<a href="http://www.zhukaiyuan.cn/" target="_blank">My Blog</a>　　<a onclick="<!-- donation() -->" class="layui-btn layui-btn-danger l·ayui-btn-small">小元元技术博客</a></p>
		</div>
	</div>

	<!-- 锁屏 -->
	<div class="admin-header-lock" id="lock-box" style="display: none;">
		<div class="admin-header-lock-img"><img src="/adm/images/face.jpg"/></div>
	...
	<script type="text/javascript" src="/adm/js/nav.js"></script>
	<script type="text/javascript" src="/adm/js/leftNav.js"></script>
	<script type="text/javascript" src="/adm/js/index.js"></script>
</body>
</html>